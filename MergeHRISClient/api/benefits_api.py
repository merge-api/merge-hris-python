    ...
    def __init__(self, api_client=None):
        ...
        def __benefits_create(
            ...
            **kwargs
            ...
            >>> thread = api.benefits_create(x_account_token, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                create_benefit (CreateBenefit): [optional]
        ...
        self.benefits_retrieve = Endpoint(
            settings={
                'response_type': (Benefit,),
                'auth': [
                    'tokenAuth'
