...
# **taxes_create**
> Tax taxes_create(x_account_token=x_account_token, run_async=run_async, tax=tax)
...
tax = MergeHRISClient.Tax() # Tax |  (optional)
    ...
    try:
        api_response = api_instance.taxes_create(x_account_token=x_account_token, run_async=run_async, tax=tax)
        pprint(api_response)
...
# **taxes_destroy**
> Tax taxes_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.taxes_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **taxes_list**
> PaginatedTaxList taxes_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_payroll_run_id=employee_payroll_run_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
employee_payroll_run_id = 'employee_payroll_run_id_example' # str | If provided, will only return taxes for this employee payroll run. (optional)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.taxes_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_payroll_run_id=employee_payroll_run_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
 ...
 **employee_payroll_run_id** | [**str**](.md)| If provided, will only return taxes for this employee payroll run. | [optional] 
...
> Tax taxes_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_tax=patched_tax)
...
patched_tax = MergeHRISClient.PatchedTax() # PatchedTax |  (optional)
    ...
    try:
        api_response = api_instance.taxes_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_tax=patched_tax)
        pprint(api_response)
    except ApiException as e:
...
# **taxes_retrieve**
> Tax taxes_retrieve(id, x_account_token=x_account_token)
...
x_account_token = 'x_account_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.taxes_retrieve(id, x_account_token=x_account_token)
        pprint(api_response)
    except ApiException as e:
