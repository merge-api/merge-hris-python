...
# **employments_create**
> Employment employments_create(x_link_token=x_link_token, run_async=run_async, employment=employment)
...
employment = MergeHRISClient.Employment() # Employment |  (optional)
    ...
    try:
        api_response = api_instance.employments_create(x_link_token=x_link_token, run_async=run_async, employment=employment)
        pprint(api_response)
...
# **employments_destroy**
> AsyncTaskExecution employments_destroy(id, x_link_token=x_link_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.employments_destroy(id, x_link_token=x_link_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **employments_list**
> PaginatedEmploymentList employments_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.employments_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> Employment employments_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_employment=patched_employment)
...
patched_employment = MergeHRISClient.PatchedEmployment() # PatchedEmployment |  (optional)
    ...
    try:
        api_response = api_instance.employments_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_employment=patched_employment)
        pprint(api_response)
    except ApiException as e:
...
> Employment employments_retrieve(id, x_link_token=x_link_token)
...
x_link_token = 'x_link_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.employments_retrieve(id, x_link_token=x_link_token)
        pprint(api_response)
    except ApiException as e:
