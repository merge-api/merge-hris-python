...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    create_time_off = CreateTimeOff(
        ...
        leave_type_id="leave_type_id_example",
        time_off_policy_id="time_off_policy_id_example",
        part_of_day="part_of_day_example",
    ) # CreateTimeOff |  (optional)
    ...
    # and optional values
    try:
        api_response = api_instance.time_off_create(x_account_token, run_async=run_async, create_time_off=create_time_off)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling TimeOffApi->time_off_create: %s\n" % e)
```
 ...
 **create_time_off** | [**CreateTimeOff**](CreateTimeOff.md)|  | [optional]
