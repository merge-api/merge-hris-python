...
# **earnings_destroy**
> Earning earnings_destroy(id, x_account_token=x_account_token, run_async=run_async)
...
# **earnings_list**
> PaginatedEarningList earnings_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_payroll_run_id=employee_payroll_run_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
employee_payroll_run_id = 'employee_payroll_run_id_example' # str | If provided, will only return earnings for this employee payroll run. (optional)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.earnings_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_payroll_run_id=employee_payroll_run_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
 ...
 **employee_payroll_run_id** | [**str**](.md)| If provided, will only return earnings for this employee payroll run. | [optional] 
...
# **earnings_update**
> Earning earnings_update(id, earning=earning)
...
earning = MergeHRISClient.Earning() # Earning |  (optional)
    ...
    try:
        api_response = api_instance.earnings_update(id, earning=earning)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling EarningsApi->earnings_update: %s\n" % e)
```
