...
# **payroll_runs_create**
> PayrollRun payroll_runs_create(x_link_token=x_link_token, run_async=run_async, payroll_run=payroll_run)
...
payroll_run = MergeHRISClient.PayrollRun() # PayrollRun |  (optional)
    ...
    try:
        api_response = api_instance.payroll_runs_create(x_link_token=x_link_token, run_async=run_async, payroll_run=payroll_run)
        pprint(api_response)
...
> AsyncTaskExecution payroll_runs_destroy(id, x_link_token=x_link_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.payroll_runs_destroy(id, x_link_token=x_link_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **payroll_runs_list**
> PaginatedPayrollRunList payroll_runs_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.payroll_runs_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> PayrollRun payroll_runs_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_payroll_run=patched_payroll_run)
...
patched_payroll_run = MergeHRISClient.PatchedPayrollRun() # PatchedPayrollRun |  (optional)
    ...
    try:
        api_response = api_instance.payroll_runs_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_payroll_run=patched_payroll_run)
        pprint(api_response)
    except ApiException as e:
...
> PayrollRun payroll_runs_retrieve(id, x_link_token=x_link_token)
...
x_link_token = 'x_link_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.payroll_runs_retrieve(id, x_link_token=x_link_token)
        pprint(api_response)
    except ApiException as e:
