...
class DepartmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __departments_partial_update(
            self,
            x_account_token,
            id,
            **kwargs
            ...
            >>> thread = api.departments_partial_update(x_account_token, id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                patched_department (PatchedDepartment): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.departments_partial_update = Endpoint(
            settings={
                ...
                'operation_id': 'departments_partial_update',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__departments_partial_update
        )
