...
# **companies_create**
> Company companies_create(company=company)
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.companies_create(company=company)
        pprint(api_response)
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.companies_destroy(id)
    except ApiException as e:
...
# **companies_list**
> PaginatedCompanyList companies_list(cursor=cursor, linked_account_id=linked_account_id, origin_id=origin_id)
...
origin_id = 'origin_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.companies_list(cursor=cursor, linked_account_id=linked_account_id, origin_id=origin_id)
        pprint(api_response)
    except ApiException as e:
...
> Company companies_partial_update(id, patched_company=patched_company)
...
patched_company = MergeHRISClient.PatchedCompany() # PatchedCompany |  (optional)
    ...
    try:
        api_response = api_instance.companies_partial_update(id, patched_company=patched_company)
        pprint(api_response)
    except ApiException as e:
