...
class SyncStatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __sync_status_retrieve(
            self,
            x_account_token,
            **kwargs
        ):
            """sync_status_retrieve  # noqa: E501

            Get syncing status.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.sync_status_retrieve(x_account_token, async_req=True)
            >>> result = thread.get()
        ...
        self.sync_status_retrieve = Endpoint(
            settings={
                ...
                'operation_id': 'sync_status_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__sync_status_retrieve
        )
