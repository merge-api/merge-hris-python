...
class LocationsApi(object):
    ...
    def locations_list(self, x_account_token, **kwargs):  # noqa: E501
        ...
        return self.locations_list_with_http_info(x_account_token, **kwargs)  # noqa: E501

    def locations_list_with_http_info(self, x_account_token, **kwargs):  # noqa: E501
        """locations_list  # noqa: E501

        Returns a list of `Location` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.locations_list_with_http_info(x_account_token, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `locations_list`")  # noqa: E501
    ...
    def locations_retrieve(self, x_account_token, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.locations_retrieve_with_http_info(x_account_token, id, **kwargs)  # noqa: E501

    def locations_retrieve_with_http_info(self, x_account_token, id, **kwargs):  # noqa: E501
        """locations_retrieve  # noqa: E501

        Returns a `Location` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.locations_retrieve_with_http_info(x_account_token, id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_account_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `locations_retrieve`")  # noqa: E501
