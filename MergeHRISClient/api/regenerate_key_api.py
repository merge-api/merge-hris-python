    ...
    def __init__(self, api_client=None):
        ...
        def __regenerate_key_create(
            ...
            **kwargs
            ...
            >>> thread = api.regenerate_key_create(remote_key_for_regeneration, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['remote_key_for_regeneration'] = \
                remote_key_for_regeneration
            return self.call_with_http_info(**kwargs)

        self.regenerate_key_create = Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    'remote_key_for_regeneration': 'body',
                },
