...
class InterviewsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __interviews_partial_update(
            self,
            x_account_token,
            id,
            **kwargs
        ):
            """interviews_partial_update  # noqa: E501

            Updates a `ScheduledInterview` object with the given `id`.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.interviews_partial_update(x_account_token, id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                patched_scheduled_interview (PatchedScheduledInterview): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.interviews_partial_update = Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'id': 'path',
                    'run_async': 'query',
                    'patched_scheduled_interview': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__interviews_partial_update
        )
        ...
        self.interviews_retrieve = Endpoint(
            settings={
                'response_type': (ScheduledInterview,),
                'auth': [
                    'tokenAuth'
