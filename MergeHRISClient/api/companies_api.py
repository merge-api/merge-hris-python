...
class CompaniesApi(object):
    ...
    def companies_list(self, x_account_token, **kwargs):  # noqa: E501
        ...
        return self.companies_list_with_http_info(x_account_token, **kwargs)  # noqa: E501

    def companies_list_with_http_info(self, x_account_token, **kwargs):  # noqa: E501
        """companies_list  # noqa: E501

        Returns a list of `Company` objects.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.companies_list_with_http_info(x_account_token, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `companies_list`")  # noqa: E501
    ...
    def companies_retrieve(self, x_account_token, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.companies_retrieve_with_http_info(x_account_token, id, **kwargs)  # noqa: E501

    def companies_retrieve_with_http_info(self, x_account_token, id, **kwargs):  # noqa: E501
        """companies_retrieve  # noqa: E501

        Returns a `Company` object with the given `id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.companies_retrieve_with_http_info(x_account_token, id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_account_token' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_account_token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_account_token` when calling `companies_retrieve`")  # noqa: E501
