...
# **documents_create**
> Document documents_create(x_link_token=x_link_token, run_async=run_async, document=document)
...
document = MergeHRISClient.Document() # Document |  (optional)
    ...
    try:
        api_response = api_instance.documents_create(x_link_token=x_link_token, run_async=run_async, document=document)
        pprint(api_response)
...
# **documents_destroy**
> AsyncTaskExecution documents_destroy(id, x_link_token=x_link_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.documents_destroy(id, x_link_token=x_link_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **documents_list**
> PaginatedDocumentList documents_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.documents_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> Document documents_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_document=patched_document)
...
patched_document = MergeHRISClient.PatchedDocument() # PatchedDocument |  (optional)
    ...
    try:
        api_response = api_instance.documents_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_document=patched_document)
        pprint(api_response)
    except ApiException as e:
...
# **documents_retrieve**
> Document documents_retrieve(id, x_link_token=x_link_token)
...
x_link_token = 'x_link_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.documents_retrieve(id, x_link_token=x_link_token)
        pprint(api_response)
    except ApiException as e:
