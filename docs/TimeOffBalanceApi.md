...
> PaginatedTimeOffBalanceList time_off_balance_list(x_account_token)
...
from MergeHRISClient.api import time_off_balance_api
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    api_instance = time_off_balance_api.TimeOffBalanceApi(api_client)
    ...
    try:
        api_response = api_instance.time_off_balance_list(x_account_token)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling TimeOffBalanceApi->time_off_balance_list: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.time_off_balance_list(x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_id=employee_id, expand=expand, include_remote_data=include_remote_data, modified_after=modified_after, modified_before=modified_before, page_size=page_size, policy_type=policy_type, remote_id=remote_id)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling TimeOffBalanceApi->time_off_balance_list: %s\n" % e)
```
...
> TimeOffBalance time_off_balance_retrieve(x_account_token, id)
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.time_off_balance_retrieve(x_account_token, id)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling TimeOffBalanceApi->time_off_balance_retrieve: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.time_off_balance_retrieve(x_account_token, id, expand=expand, include_remote_data=include_remote_data)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling TimeOffBalanceApi->time_off_balance_retrieve: %s\n" % e)
```
