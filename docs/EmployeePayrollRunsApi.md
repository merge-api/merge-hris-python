...
> EmployeePayrollRun employee_payroll_runs_create(x_account_token=x_account_token, run_async=run_async, employee_payroll_run=employee_payroll_run)
...
employee_payroll_run = MergeHRISClient.EmployeePayrollRun() # EmployeePayrollRun |  (optional)
    ...
    try:
        api_response = api_instance.employee_payroll_runs_create(x_account_token=x_account_token, run_async=run_async, employee_payroll_run=employee_payroll_run)
        pprint(api_response)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.employee_payroll_runs_destroy(id, x_account_token=x_account_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
> PaginatedEmployeePayrollRunList employee_payroll_runs_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee=employee, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, payroll_run_id=payroll_run_id, remote_id=remote_id)
...
employee = 'employee_example' # str | If provided, will only return employee payroll runs for this employee. (optional)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.employee_payroll_runs_list(x_account_token=x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee=employee, expand=expand, modified_after=modified_after, modified_before=modified_before, page_size=page_size, payroll_run_id=payroll_run_id, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
 ...
 **employee** | [**str**](.md)| If provided, will only return employee payroll runs for this employee. | [optional] 
 ...
 **payroll_run_id** | [**str**](.md)| If provided, will only return employee payroll runs for this employee. | [optional] 
...
> EmployeePayrollRun employee_payroll_runs_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_employee_payroll_run=patched_employee_payroll_run)
...
patched_employee_payroll_run = MergeHRISClient.PatchedEmployeePayrollRun() # PatchedEmployeePayrollRun |  (optional)
    ...
    try:
        api_response = api_instance.employee_payroll_runs_partial_update(id, x_account_token=x_account_token, run_async=run_async, patched_employee_payroll_run=patched_employee_payroll_run)
        pprint(api_response)
    except ApiException as e:
...
> EmployeePayrollRun employee_payroll_runs_retrieve(id, x_account_token=x_account_token, expand=expand)
...
expand = 'expand_example' # str | Which relations should be returned in expanded form. (optional)
    ...
    try:
        api_response = api_instance.employee_payroll_runs_retrieve(id, x_account_token=x_account_token, expand=expand)
        pprint(api_response)
    except ApiException as e:
