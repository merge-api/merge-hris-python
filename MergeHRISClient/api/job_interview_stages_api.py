...
class JobInterviewStagesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.job_interview_stages_list = Endpoint(
            settings={
        ...
        def __job_interview_stages_partial_update(
            self,
            x_account_token,
            id,
            **kwargs
        ):
            """job_interview_stages_partial_update  # noqa: E501

            Updates a `JobInterviewStage` object with the given `id`.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.job_interview_stages_partial_update(x_account_token, id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                ...
                patched_job_interview_stage (PatchedJobInterviewStage): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.job_interview_stages_partial_update = Endpoint(
            settings={
                ...
                'operation_id': 'job_interview_stages_partial_update',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'id': 'path',
                    'run_async': 'query',
                    'patched_job_interview_stage': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__job_interview_stages_partial_update
        )
        ...
        self.job_interview_stages_retrieve = Endpoint(
            settings={
                'response_type': (JobInterviewStage,),
                'auth': [
                    'tokenAuth'
