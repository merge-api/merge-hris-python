...
# **documents_list**
> PaginatedDocumentList documents_list(x_account_token)
...
from MergeHRISClient.api import documents_api
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.documents_list(x_account_token)
        pprint(api_response)
 ...
 **employee_id** | **str**| If provided, will only return documents for this employee. | [optional]
