...
# **teams_create**
> Team teams_create(x_link_token=x_link_token, run_async=run_async, team=team)
...
team = MergeHRISClient.Team() # Team |  (optional)
    ...
    try:
        api_response = api_instance.teams_create(x_link_token=x_link_token, run_async=run_async, team=team)
        pprint(api_response)
...
# **teams_destroy**
> AsyncTaskExecution teams_destroy(id, x_link_token=x_link_token, run_async=run_async)
...
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
    ...
    try:
        api_response = api_instance.teams_destroy(id, x_link_token=x_link_token, run_async=run_async)
        pprint(api_response)
    except ApiException as e:
...
# **teams_list**
> PaginatedTeamList teams_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
...
remote_id = 'remote_id_example' # str | The API provider's ID for the given object. (optional)
    ...
    try:
        api_response = api_instance.teams_list(x_link_token=x_link_token, created_after=created_after, created_before=created_before, cursor=cursor, linked_account_id=linked_account_id, modified_after=modified_after, modified_before=modified_before, page_size=page_size, remote_id=remote_id)
        pprint(api_response)
    except ApiException as e:
...
> Team teams_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_team=patched_team)
...
x_link_token = 'x_link_token_example' # str | Token identifying the end user. (optional)
run_async = True # bool | Whether or not third-party updates should be run asynchronously. (optional)
patched_team = MergeHRISClient.PatchedTeam() # PatchedTeam |  (optional)

    try:
        api_response = api_instance.teams_partial_update(id, x_link_token=x_link_token, run_async=run_async, patched_team=patched_team)
        pprint(api_response)
    except ApiException as e:
...
# **teams_retrieve**
> Team teams_retrieve(id, x_link_token=x_link_token)
...
x_link_token = 'x_link_token_example' # str | Token identifying the end user. (optional)
    ...
    try:
        api_response = api_instance.teams_retrieve(id, x_link_token=x_link_token)
        pprint(api_response)
    except ApiException as e:
