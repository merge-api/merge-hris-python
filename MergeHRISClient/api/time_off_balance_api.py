...
class TimeOffBalanceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __time_off_balance_list(
            self,
            x_account_token,
            **kwargs
        ):
            """time_off_balance_list  # noqa: E501

            Returns a list of `TimeOffBalance` objects.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.time_off_balance_list(x_account_token, async_req=True)
            >>> result = thread.get()
        ...
        self.time_off_balance_list = _Endpoint(
            settings={
                'response_type': (PaginatedTimeOffBalanceList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/time-off-balance',
                'operation_id': 'time_off_balance_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__time_off_balance_list
        )

        def __time_off_balance_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
            ...
            >>> thread = api.time_off_balance_retrieve(x_account_token, id, async_req=True)
            >>> result = thread.get()
        ...
        self.time_off_balance_retrieve = _Endpoint(
            settings={
                'response_type': (TimeOffBalance,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/time-off-balance/{id}',
                'operation_id': 'time_off_balance_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__time_off_balance_retrieve
        )
