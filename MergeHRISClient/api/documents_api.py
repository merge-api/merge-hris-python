...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.documents_list = Endpoint(
            ...
            callable=__documents_list
        )

        def __documents_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.documents_retrieve = Endpoint(
            settings={
                'response_type': (Document,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/documents/{id}',
