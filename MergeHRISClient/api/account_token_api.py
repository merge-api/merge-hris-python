...
class AccountTokenApi(object):
    ...
    def account_token_retrieve_with_http_info(self, production_key, public_token, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AccountToken, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method account_token_retrieve" % key
                )
        ...
        if self.api_client.client_side_validation and ('public_token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `public_token` when calling `account_token_retrieve`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='AccountToken',  # noqa: E501
