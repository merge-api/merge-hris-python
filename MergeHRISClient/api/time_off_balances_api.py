...
class TimeOffBalancesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.time_off_balances_list = _Endpoint(
            settings={
                'response_type': (PaginatedTimeOffBalanceList,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/time-off-balances',
            ...
            callable=__time_off_balances_list
        )

        def __time_off_balances_retrieve(
            self,
            x_account_token,
            id,
            **kwargs
        ...
        self.time_off_balances_retrieve = _Endpoint(
            settings={
                'response_type': (TimeOffBalance,),
                'auth': [
                    'tokenAuth'
                ],
                'endpoint_path': '/time-off-balances/{id}',
            ...
            api_client=api_client,
            callable=__time_off_balances_retrieve
        )
