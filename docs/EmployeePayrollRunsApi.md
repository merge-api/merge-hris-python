...
> EmployeePayrollRun employee_payroll_runs_create(x_account_token)
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    create_employee_payroll_run = CreateEmployeePayrollRun(
        ...
        check_date=dateutil_parser('1970-01-01T00:00:00.00Z'),
    ...
    ) # CreateEmployeePayrollRun |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.employee_payroll_runs_create(x_account_token)
        pprint(api_response)
    ...
    # and optional values
    try:
        api_response = api_instance.employee_payroll_runs_create(x_account_token, run_async=run_async, create_employee_payroll_run=create_employee_payroll_run)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling EmployeePayrollRunsApi->employee_payroll_runs_create: %s\n" % e)
```
 ...
 **create_employee_payroll_run** | [**CreateEmployeePayrollRun**](CreateEmployeePayrollRun.md)|  | [optional]
...
with MergeHRISClient.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.employee_payroll_runs_list(x_account_token, created_after=created_after, created_before=created_before, cursor=cursor, employee_id=employee_id, expand=expand, include_remote_data=include_remote_data, modified_after=modified_after, modified_before=modified_before, page_size=page_size, payroll_run_id=payroll_run_id, remote_id=remote_id)
        pprint(api_response)
    except MergeHRISClient.ApiException as e:
        print("Exception when calling EmployeePayrollRunsApi->employee_payroll_runs_list: %s\n" % e)
```
